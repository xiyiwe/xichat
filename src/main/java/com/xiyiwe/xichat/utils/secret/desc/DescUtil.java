package com.xiyiwe.xichat.utils.secret.desc;
...
public class DescUtil {
    ...
    private static final String PASSWORD_CRYPT_KEY = "xiyiweig";
    ...
    public static boolean checkPassWord(String formPwd, String sourcePwd) {
        if (null == formPwd || null == sourcePwd) {
            return false;
        }
        return encrypt(formPwd).equals(sourcePwd);
    }
